...
from ML.models.inceptionV3.inceptionV3_weights import inceptionV3_imagenet


def get_model(shape=(224, 224, 6), dense=[1024, 1024], data_format=None):
